...
/**
 * mitic implementation of the Controller ofg the question processing stage.
 * 
...
public class Controller extends FrameworkController {
	 ...
	 */
	// CARGA 3 MODULOS QUE SE EJECUTAN EN ORDEN (En Notify de framework.ar.QuestionProcessor.Notify())
  // textprocessing.QuestionClassifierWithStandfordClassifier
  // textprocessing.StandfordNER
  // textprocessing.StandfordPOSTagger
  @Override
